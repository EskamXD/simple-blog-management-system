...
class GUI(BlogManagement):
    def __init__(self, db: "Database", root: "Category") -> None:
        ...
        self.add_article_view = AddArticleView(
            self.root, self.add_article_tab, self.add_article_controller
        )

        self.photo_gallery_controller = PhotoGalleryController(self.root)
        self.photo_gallery_view = PhotoGalleryView(
            self.root, self.photo_gallery_tab, self.photo_gallery_controller
        )
        ...
        self.update_status_view = UpdateStatusView(
            self.root, self.update_status_tab, self.update_status_controller
        )
